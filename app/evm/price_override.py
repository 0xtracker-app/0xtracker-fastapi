...
class TokenOverride:
    ...
    def __init__(self, session=None):
        self.tokens = {
            ...
            '0x94cea04c51e7d3ec0a4a97ac0c3b3c9254c2ad41'.lower() : [get_price_from_router, {'token_in' : '0x7ad7242a99f21aa543f9650a56d141c57e4f6081', 'network' : 'bsc', 'router' : routers.BSCRouter.PCSV2, 'token_out' : '0xe9e7cea3dedca5984780bafc599bd69add087d56', 'decimal': 9, 'return_token' : '0x94cea04c51e7d3ec0a4a97ac0c3b3c9254c2ad41'}],
            ...
            '0xE269abBFAF52b26D2632F55B6b223A5223088B96'.lower() : [get_price_from_synpool, {'token_in' : '0xE269abBFAF52b26D2632F55B6b223A5223088B96','swap_address' : '0x3ea9B0ab55F34Fb188824Ee288CeaEfC63cf908e', 'token_out_index' : 0, 'decimal' : 18, 'network' : 'harmony'}],
